...
class Hikes {
  ...
  showOneHike(hikeName) {
    ...
    submitBtn.addEventListener('click', () => {
      ...
      const hikeName = document.getElementById('name').innerHTML;
      create_comment(commentText, hikeName);
    });
...
function renderOneHikeFull(hike) {
  ...
  item.innerHTML = ` 
        ...
        <div>
            <input type="text" id="commentText" placeholder="Enter a comment"></input>
...
function create_comment(hikeName, comment) {
  const newComment = {
    name: hikeName,
    date: new Date(),
    content: comment
...
function renderCommentList(newComments){
...
function filterCommentsByName(hike){
